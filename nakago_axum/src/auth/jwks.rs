...
use nakago::{Config, Inject, InjectResult, Provide, Tag};
use thiserror::Error;

use super::AuthConfig;

/// The JWKS Tag
pub const JWKS: Tag<Arc<JWKSet<Empty>>> = Tag::new("JWKS");
...
#[async_trait]
impl<C: Config> Provide<Arc<JWKSet<Empty>>> for ProvideJwks<C>
where
    AuthConfig: FromRef<C>,
{
    async fn provide(&self, i: &Inject) -> InjectResult<Arc<JWKSet<Empty>>> {
