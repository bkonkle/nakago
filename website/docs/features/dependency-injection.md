...
```rust
nakago::container::test::entity::DynamoRepository was not found

Available:
 - std::boxed::Box<dyn nakago::container::test::entity::Repository>

 - nakago::container::test::entity::PostgresRepository
```
