...
use nakago_examples_auth_server::{init, Config};
...
impl TestUtils {
    pub async fn init() -> Result<Self> {
        ...
        let config_path = std::env::var("CONFIG_PATH_AUTH_SERVER")
            .unwrap_or_else(|_| "examples/auth-server/config/test.toml".to_string());
